...
$(NAME): $(OBJECTS)
	...
	$(CC) $(CFLAGS) $(SOURCES) sources/ft_printf/libftprintf.a sources/get_next_line/get_next_line.a sources/libft_ext/libft_ext.a sources/libft/libft.a -lbsd -lmlx -lXext -lX11 -o so_long
